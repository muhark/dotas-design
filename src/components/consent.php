      ...
      <div class="sv-question" style="flex: 1 1 100%; width: 100%; min-width: 300px; max-width: initial;" id="consent0" name="consent0">
        ...
        ?>" target="_self">
          ...
          <ol type="1">
            ...
            <li> <input type="checkbox" id="consent2" name="consent2" value="1"><label for="consent2">I understand that my participation is voluntary and that I am free to withdraw at any time, without giving any reason, and without any adverse
                consequences or penalty.</label>
            <li> <input type="checkbox" id="consent3" name="consent3" value="1"><label for="consent3">I understand that research data collected during the study may be looked at by authorised people outside the research team. I give permission for
                these individuals to access my data.</label>
            <li> <input type="checkbox" id="consent4" name="consent4" value="1"><label for="consent4">I understand that this project has been reviewed by, and received ethics clearance through, the University of Oxford Central University Research
                Ethics Committee.</label>
            <li> <input type="checkbox" id="consent5" name="consent5" value="1"><label for="consent5">I understand who will have access to personal data provided, how the data will be stored and what will happen to the data at the end of the
                project.</label>
            <li> <input type="checkbox" id="consent6" name="consent6" value="1"><label for="consent6">I understand how this research will be written up and published.</label>
            <li> <input type="checkbox" id="consent7" name="consent7" value="1"><label for="consent7">I understand how to raise a concern or make a complaint.</label>
            <li> <input type="checkbox" id="consent8" name="consent8" value="1"><label for="consent8">I agree to take part in the study.</label>
            <li> <input type="checkbox" id="consent9" name="consent9" value="1"><label for="consent9">I agree for research data collected in this study to be given to researchers, including those working outside of the UK and the EU, to be used in
